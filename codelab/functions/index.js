...
app.intent('favorite color', (conv, { color }) => {
    ...
    if (conv.data.userName) {
        conv.ask(`<speak>${conv.data.userName}, your lucky number is ${luckyNumber}.
        <audio src="${audioSound}"/>
         Would you like to hear about some fake colors ?</speak>`);
    } else {
        conv.ask(`<speak> Your lucky number is ${luckyNumber}.
         <audio src="${audioSound}"/> 
          Would you like to hear about some fake colors ?</speak>`);
    }
    conv.data.luckyNumber = color.length;
});
